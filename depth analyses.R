...
plot(rowSums(get(ssn),na.rm=T)~unique(years)[1:nrow(get(ssn))], ylab="Number per liter", xlab="Year",  main=paste(taxa,ssn), pch=15, cex.lab=1.5, cex.axis=1.5) 
...
legend("top",pch=15, legend=paste(taxa,"p=",round(p,4)))}
